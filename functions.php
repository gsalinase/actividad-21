...
function lawyeria_lite_enqueue_scripts() {
    ...
    wp_enqueue_script( 'lawyeria_lite_twenty_twenty', get_template_directory_uri() . '/js/jquery.twentytwenty.js', array( 'jquery' ), '1.0', true );
    wp_enqueue_script( 'lawyeria_lite_event_move', get_template_directory_uri() . '/js/jquery.event.move.js', array( 'jquery' ), '1.0', true );
